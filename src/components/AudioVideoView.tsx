...
import {
  generateQuantumAudioBrief,
  generateQuantumVideoBrief,
...
export function AudioVideoView({ config, onBack }: AudioVideoViewProps) {
  const [prompt, setPrompt] = useKV(`${config.id}-draft`, '')
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setHistory((old) =>
        [
          {
            ...createHistoryEntry(config.id, prompt, result.brief),
      ...
      toast.success(
        ` ${mediaType === 'audio' ? 'Audio' : 'Video'} brief generated!`,
        {
  ...
  return (
    <div className="min-h-screen px-4 py-6 md:px-8 md:py-8 w-full overflow-x-hidden">
            ...
            <div className="space-y-3">
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-2">
                      <Label htmlFor="audio-mode" className="text-xs">
                        Mode
                      </Label>
                      <Select
                        value={formData.mode}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="audio-duration" className="text-xs">
                        Duration
                      </Label>
                      <Input
                        id="audio-duration"
              ...
              {mediaType === 'video' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="video-duration" className="text-xs">
                      Video Length
                    </Label>
                    <Input
                      id="video-duration"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="video-audience" className="text-xs">
                      Target Audience
                    </Label>
                    <Input
                      id="video-audience"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="video-tone" className="text-xs">
                      Tone
                    </Label>
                    <Input
                      id="video-tone"
              ...
              <div className="space-y-2">
                <Label htmlFor="main-idea" className="text-xs">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <h2 className="text-xs font-semibold uppercase tracking-wider text-accent">
                        📡 {mediaType === 'audio' ? 'Audio' : 'Video'} Brief
                        Output
                      </h2>
                    </div>
                    <Button
                  ...
                  <div className="p-4 md:p-5">
                    ...
                    <div className="mt-5 pt-5 border-t border-border/30">
                      <p className="text-xs text-muted-foreground">
                        <strong>Next Steps:</strong> Use the prompts above with
                        AI tools like{' '}
                        {mediaType === 'audio'
      ...
      <div className="max-w-[1400px] mx-auto h-96 mt-8">
        <HistoryPanel
          history={history}
          onSelectEntry={setHistoryEntry}
          onDeleteEntry={(id) =>
