  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="fixed top-0 left-0 h-dvh w-72 glass-panel border-r border-border/50 z-50 lg:translate-x-0 lg:z-0 flex flex-col touch-pan-y"
      >
        ...
        <div className="p-4 border-t border-border/30 space-y-3">
          ...
          <Dialog>
            ...
            <DialogContent
              className="max-w-2xl h-[80vh] p-0"
              aria-describedby={undefined}
            >
              <DialogTitle className="sr-only">Response cache</DialogTitle>
          ...
          <div className="text-xs text-muted-foreground space-y-1">
            <div>AI Control Center v2.1</div>
            <div className="text-[10px] opacity-60">
              Powered by Multi-Engine Architecture
            </div>
          </div>
        </div>
      </motion.aside>
